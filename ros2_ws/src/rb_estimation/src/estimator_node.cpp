...
namespace rbci = rb_estimation::internal;
...
public:
  ...
  : Node("rb_estimator")
  {
    ...
    estimated_state_pub_ = this->create_publisher<rb_interfaces::msg::EstimatedState>(
...
private:
  ...
  void publish_estimated_state(const builtin_interfaces::msg::Time & stamp)
  {
    ...
    rb_interfaces::msg::EstimatedState msg;
  ...
  rclcpp::Publisher<rb_interfaces::msg::EstimatedState>::SharedPtr estimated_state_pub_;
