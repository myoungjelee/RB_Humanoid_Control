...
- M3 증빙: `reports/sim2real/images/m3_command.png`
- M4 완료: safety gating(`CLAMP/JOINT_LIMIT/TIMEOUT/TILT`) reason 로그 검증
- M4 증빙: `reports/sim2real/images/m4_safety.png`
...
## M3 증빙 이미지
![M3 Command Apply Proof](images/m3_command.png)

## M4 증빙 이미지
![M4 Safety Proof](images/m4_safety.png)
