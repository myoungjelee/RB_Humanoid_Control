...
## 빠른 링크
- 최종 시연영상: [reports/sim2real/video/RB_Humanoid_Control.mp4](reports/sim2real/video/RB_Humanoid_Control.mp4)
...
- 영상 제작 가이드: [docs/video/VIDEO_CAPTURE_GUIDE.md](docs/video/VIDEO_CAPTURE_GUIDE.md)
...
## 최종 시연영상
아래 이미지를 클릭하면 최종 시연영상을 볼 수 있습니다.

[![Final Demo](reports/sim2real/images/standalone_backend/m8_disturb_recovered.png)](reports/sim2real/video/RB_Humanoid_Control.mp4)

- 영상 구성: `before fail -> M7 standing -> M8 disturbance OFF/ON -> M9 KPI summary`
- 최종 영상 파일: [reports/sim2real/video/RB_Humanoid_Control.mp4](reports/sim2real/video/RB_Humanoid_Control.mp4)
