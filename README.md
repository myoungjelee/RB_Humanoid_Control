...
- run별 대표 아티팩트 위치
  - `logs/sim2real/<run_id>/m7/fall_event.txt`
  - `logs/sim2real/<run_id>/m7/reason_count.txt`
  - `logs/sim2real/<run_id>/m7/sync_markers.txt`
  - `logs/sim2real/<run_id>/m7/loop_post_sync.txt`
  - `logs/sim2real/<run_id>/m7/loop_before_fall.txt`
