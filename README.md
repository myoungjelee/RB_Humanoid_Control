...
| M4 | safety gating 구조 정리 | `CLAMP`, `JOINT_LIMIT`, `TIMEOUT`, `TILT` 개별 증빙 | [CLAMP](reports/sim2real/images/standalone_backend/m4_clamp_standalone.png), [JOINT_LIMIT](reports/sim2real/images/standalone_backend/m4_joint_limit_standalone.png), [TIMEOUT](reports/sim2real/images/standalone_backend/m4_timeout_standalone.png), [TILT](reports/sim2real/images/standalone_backend/m4_tilt_standalone.png) |
...
- M3 Command Apply: 완료
- M4 Safety Layer: 완료
- M5 Controller-only standing hold: 진행 중, 핵심 원인 해결
- 다음 게이트: safety 재통합

## 다음 단계
- M5: safety 켠 상태로 standing 재검증
- M5+: disturbance A/B 및 recovery evidence
- M6: KPI/report 마감 정리
